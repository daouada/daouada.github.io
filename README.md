...
For updating the bibliography of the publication you have to install this parser.

```bash
pip install bibtexparser
```

Then place the publication.bib file in the root path of this directory. Then run the following python script

```
python3 tools/generate_publications.py
```
This will create a json file publications.json from the publications.bib, which will help correctly display the publications in the research section.
